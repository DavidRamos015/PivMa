...
{
    public class MyAccountInputModel
    {
        ...
        [StringLength(100,ErrorMessage="Debe ser menor de 100 caractereres.")]
        [DataType(DataType.EmailAddress, ErrorMessage = "El correo tiene un formato invalido.")]
