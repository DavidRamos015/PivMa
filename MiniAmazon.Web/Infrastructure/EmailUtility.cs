    ...
    public class EmailUtility
    {
        ...
        public static bool SendEmail(IRepository repository, string emailtoSend, string displayName, string body, string subject, MailOperationType mailOperationType, bool async)
        {
            try
            {
                ...
                string imgPath = @"E:\Cloud Computing\dropbox\Dropbox\unitec\prog4\proyecto\pivma resource\OnlineStore.jpg";
                ...
                if (System.IO.File.Exists(imgPath))
                {
                    ...
                    var lr = new LinkedResource(@"E:\Cloud Computing\dropbox\Dropbox\unitec\prog4\proyecto\pivma resource\OnlineStore.jpg",
